...
Assembles draft files into a single manuscript:
...
**Use when:** Manuscript is complete or near-complete, preparing for submission, wanting a single-file view.
